...
int main()
{
	...
	//
		...
		//myDocument->LoadFile("C:\\Student.xml");
		TiXmlDocument myDocument( "studentXml" );
		myDocument.Parse( studentXml );
...
//				std::cout << attributeOfStudent->Name() << " : " << attributeOfStudent->Value() << std::endl;
...

    {
            ...
            TiXmlHandle docHandle( &doc );
            TiXmlHandle aHandle = docHandle.FirstChildElement( "ddd" );
            TiXmlHandle tHandle = aHandle.Child( 0 );
            assert( aHandle.Element() );
            assert( tHandle.Text() );
            XmlTest( "ISO-8859-1 Parsing.", "cccc", tHandle.Text()->Value() );
    }
