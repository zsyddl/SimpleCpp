...
#ifndef DeviceGatewayIf_H
#define DeviceGatewayIf_H
...
class DEVICEGATEWAYIF_API CDeviceGatewayIf:public CRpcService
{
public:
	CDeviceGatewayIf(void);
	virtual ~CDeviceGatewayIf(void);
	//必须是int 返回类型必须是int
